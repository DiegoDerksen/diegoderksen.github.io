...
Are your users seeing a firewall windows regarding Teams when they first logon? Fear not! In this article, we'll walk you through a swift solution using an Intune remediation script.
...
Let's device into the Detect and Remediate scripts. Just copy-paste this and save as a Powershell script.
