...
1. Go to https://github.com/mozilla/policy-templates/releases and get the "Policy_Templates_Vx_xx.zip" file
2. Unzip this file
...
14. OMA-URI -> ./Device/Vendor/MSFT/Policy/Config/Firefox~Policy~firefox~Extensions/ExtensionSettings
15. Data Type -> String
16. You can now use the folowing example. This will force install ublock, allow 1password and block everything else: 
```json
{
...
```
17. You can now push this to your users.
